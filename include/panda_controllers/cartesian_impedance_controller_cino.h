...
class CartesianImpedanceControllerCino : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  double stiffness_scale_factor_{8.5};
  const double kDefaultStiffness{400.0};
